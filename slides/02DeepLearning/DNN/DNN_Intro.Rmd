...
- Two features: ($x_1$ and $x_2$); linear functions to separate classes; find ($w_0$, $w_1$, $w_w$￼) such that:
...
- Perceptron algorithm is  easy to be implemented in any modern program language. 
...
- It is a linear classification function and the weight is updated after each data points are feed to the algorithm (concept similar to stochastic gradient descent).
